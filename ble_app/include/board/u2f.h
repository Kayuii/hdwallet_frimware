...
typedef void (*u2f_rx_callback_t)(transport_message_t* msg,
                                  const U2F_AUTHENTICATE_REQ *req);
typedef void (*u2f_debug_rx_callback_t)(transport_message_t* msg,
                                        const U2F_AUTHENTICATE_REQ *req);

void u2f_set_rx_callback(u2f_rx_callback_t callback);
void u2f_set_debug_rx_callback(u2f_debug_rx_callback_t callback);
